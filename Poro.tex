...
{\bf\Huge
Сообщение о языке программирования Поро
...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\{\textcolor{Black}{\textbf{dig}}\}|\{\textcolor{Black}{\textbf{small}}\})}\textcolor{Black}{\textbf{log}} }
\end{center}
...
\texttt{x}          & \texttt{y}        & \texttt{x||y}     & \texttt{x\&\&y}   & \texttt{x\^{ }\^{ }y} & \texttt{x(+)y}  & \texttt{x(-)y}\\  \hline
\textbf{false}       & \textbf{false}     & \textbf{false}     & \textbf{false}     & \textbf{false}     & \textbf{false} & \textbf{true}   \\  \hline
\textbf{false}       & \textbf{true}   & \textbf{true}   & \textbf{false}     & \textbf{true}    & \textbf{true}  & \textbf{true}  \\  \hline
\textbf{true}     & \textbf{false}     & \textbf{true}   & \textbf{false}     & \textbf{true}   & \textbf{true}  & \textbf{true}   \\  \hline
\textbf{true}     & \textbf{true}   & \textbf{true}   & \textbf{true}   & \textbf{false}     & \textbf{true} & \textbf{false}   \\  \hline
\end{longtable}
...
\texttt{==}             & равно                                             \\
\texttt{!=}             & не равно                                          \\
\texttt{@->}             &  первая цифра из числа                                       \\
\texttt{<-@}             &  последняя цифра из числа                                \\
...
\subsection{Убийца}
\textcolor{Green}{\syntax{%
\synt{убийца}$\to$\textcolor{Black}{\textbf{kill}}\textcolor{Black}{\texttt{(}}\synt{S}\textcolor{Black}{\texttt{)}}}} \\
Уничтожает объект.
...
\begin{center}
\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{ext}} [\textcolor{Black}{\textbf{из}} \synt{имя_цикла}]}}
\end{center}
